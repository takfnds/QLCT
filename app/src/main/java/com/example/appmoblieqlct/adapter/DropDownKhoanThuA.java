...
public class DropDownKhoanThuA extends ArrayAdapter<Category> {

    public DropDownKhoanThuA(@NonNull Context context, int resource, @NonNull List<Category> objects) {
